 ...
 *
 * Modified by Ben Kamens on November 15th, 2010, to support reporting duration/time back to JS (jsSendStats)
 */ 
...
class TemplateMaxi extends TemplateMaxiBase
{
    ...
    public function jsSendStats()
    {
        ...
        ExternalInterface.call("VideoStats.cacheStats", position, duration);
    }
