...
NewSignificantFigures.MultiplySignificantFigures = new function(){
    ...
    var _createNumber = function(){
        ...
        _equation = 'Find the  Number of Significant Figures in: ' + lStringifiedNumber+' X '+lStringifiedNumber2;
    ...
    var _makeHints = function(pNumber1,pNumber2,pAnswer) {
        ...
        str+="<div id='hint2' style='display:none;font-family: arial; font-size: 150%; font-weight: bold;margin-left:12px'><br/>Now round the multiplication result to "+answerSigCount+" significant digit(s)</div>";
