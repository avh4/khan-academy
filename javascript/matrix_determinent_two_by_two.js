...
Matrix.Determinent = new function(){
    ...
    var _createMatrixEqation = function(){
        ...
        $("#dvHint").append("<div><div style='float:left; font-size:250%'>\\["  + _matrixEquation + "\\]</div> <div style='float:left; font-size:250%; padding-top:18px; padding-left:8px; color:Blue;'>\\[  =  (" + _matrix[0][0] + "*" + _matrix[1][1] + ") \\]</div> <div id='dvHint2' style='float:left; font-size:250%; padding-top:18px; padding-left:8px; display:none;'>\\[ -\\]</div> <div id='dvHint3' style='float:left; font-size:250%; padding-top:18px; padding-left:8px; display:none; color:Red;'>\\[ (" + _matrix[0][1] + "*" + _matrix[1][0] + ") \\]</div> <div id='dvHint4' style='float:left; font-size:250%; padding-top:18px; padding-left:8px; display:none;'>\\[ = " + ((_matrix[0][0]*_matrix[1][1]) - (_matrix[0][1]*_matrix[1][0])) + "  \\]</div></div>");
    }
    return {
        /*Public Methods*/
