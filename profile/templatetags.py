...
from profile import focus_graph, activity_graph, exercises_over_time_graph, exercise_problems_graph, exercise_progress_graph, recent_activity

register = webapp.template.create_template_register()

@register.inclusion_tag(("../profile/graph_control.html", "profile/graph_control.html"))
...
@register.inclusion_tag(("../profile/graph_link.html", "profile/graph_link.html"))
...
@register.inclusion_tag(("../profile/graph_date_picker.html", "profile/graph_date_picker.html"))
def profile_graph_date_picker(user, graph_type):
    return { "user": user, "graph_type": graph_type }

@register.inclusion_tag(("../profile/exercise_progress_block.html", "profile/exercise_progress_block.html"))
...
@register.inclusion_tag(("../profile/recent_activity.html", "profile/recent_activity.html"))
def profile_recent_activity(user):
    return recent_activity.recent_activity_context(user)

@register.inclusion_tag(("../profile/recent_activity_entry_badge.html", "profile/recent_activity_entry_badge.html"))
...
@register.inclusion_tag(("../profile/recent_activity_entry_exercise.html", "profile/recent_activity_entry_exercise.html"))
def profile_recent_activity_entry_exercise(student, recent_activity_entry):
    return { "recent_activity": recent_activity_entry, "student_email": student.email() }
@register.inclusion_tag(("../profile/recent_activity_entry_video.html", "profile/recent_activity_entry_video.html"))
