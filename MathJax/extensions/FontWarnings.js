...
(function (HUB) {
  var CONFIG = HUB.Insert({
    ...
    HTML: {
      ...
      fonts: [
        ...
        " or the ",
        ["a",{href:"http://www.mathjax.org/",target:"_blank"},["MathJax TeX fonts"]],
  ...
  var CREATEMESSAGE = function (data) {
    ...
    document.cookie = "mjx:fontWarn=1";  // mark that we have warned
  };
  ...
  //
  if (!document.cookie.match(/mjx:fontWarn=1/)) {
    //
